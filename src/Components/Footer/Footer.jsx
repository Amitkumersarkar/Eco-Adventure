...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-br from-blue-900 via-purple-800 to-blue-700 text-white p-10 mt-10 animate-fade-in-up">
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <nav>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li> <NavLink to='/about'> <a className="hover:text-blue-300 transition-colors duration-200 cursor-pointer">About us</a></NavLink></li>
                        <li> <NavLink to='/contact'> <a className="hover:text-blue-300 transition-colors duration-200 cursor-pointer">Contact</a></NavLink></li>
                ...
                <form>
                    ...
                    <div className="flex">
                        <input
                            ...
                            className="input input-bordered rounded-l-md focus:outline-none bg-white text-black w-full"
                        />
